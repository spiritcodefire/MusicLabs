            ...
            <div className="row justify-content-center">
                ...
                <div  className="container p-4 text-white">
                    <div className="row justify-content-between">
                        ...
                        <input onClick={aspireClick} type="button" value="Classique"    className="d-none d-sm-block btnArt px-4 mx-1 bg-white"></input>
                        <input onClick={aspireClick} type="button" value="Rock"         className="d-none d-sm-block btnArt px-4 mx-1 bg-white"></input>
                        <input onClick={aspireClick} type="button" value="Electro"       className="d-none d-sm-block btnArt px-4 mx-1 bg-white"></input>
                        <input onClick={aspireClick} type="button" value="Latino"       className="d-none d-sm-block btnArt px-4 mx-1 bg-white"></input>
                        <input onClick={aspireClick} type="button" value="Metal"        className="d-none d-sm-block btnArt px-4 mx-1 bg-white"></input>
                        <input onClick={aspireClick} type="button" value="Film"         className="d-none d-sm-block btnArt px-4 mx-1 bg-white"></input>
                        <input onClick={aspireClick} type="button" value="Jazz"         className="d-none d-sm-block btnArt px-4 mx-1 bg-white"></input>
